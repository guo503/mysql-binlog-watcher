package com.tsyj.mysql.thread;

import com.tsyj.mysql.config.MySqlHost;
import com.tsyj.mysql.core.BinlogDataDispatcher;
import com.tsyj.mysql.core.DataListenerContainer;
import com.tsyj.mysql.core.MysqlDataListenerData;
    ...
    private Connection getConnection(MySqlHost host) throws SQLException {
        ...
        if (connection == null) {
            String url =  "jdbc:mysql://" + key +
                    "/INFORMATION_SCHEMA?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai&characterEncoding=UTF-8";
